...
namespace monitor
{
    RpcClient::RpcClient(network::EventLoop *loop, const network::InetAddress &serverAddr)
        : loop_(loop),
          ...
          stubPtr_(new monitor::proto::RpcManager::Stub(channel_))
    {
        ...
        clientPtr_->setMessageCallback(std::bind(&network::RpcChannel::onMessage, channel_, std::placeholders::_1, std::placeholders::_2));
    }
    ...
    */
    void RpcClient::SetMonitorInfo(const monitor::proto::MonitorInfo *monito_info)
    {
        ...
        ::google::protobuf::Empty response;
        // 添加conn判断
        stubPtr_->SetMonitorInfo(nullptr, monito_info, &response, ::google::protobuf::NewCallback(this, &RpcClient::closure_));
    ...
    void RpcClient::GetMonitorInfo(monitor::proto::MonitorInfo *monito_info)
    {
        ...
        stubPtr_->GetMonitorInfo(NULL, &request, monito_info, ::google::protobuf::NewCallback(this, &RpcClient::closure_));
